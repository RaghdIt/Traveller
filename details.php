    ...
    border-radius: 50%;">
        ...
        <div class="place">
            ...
            <p><strong>Photo:</strong> <?php echo htmlspecialchars($photoFileName); ?></p>
             <?php if (!empty($place['photoFileName']) && file_exists($place['photoFileName'])): ?>
    <img src=<?php echo htmlspecialchars($place['photoFileName']); ?> alt="<?php echo htmlspecialchars($place['name']); ?>" style="max-width: 100%; height: auto; border-radius: 10px;">
<?php else: ?>
