...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // ✅ FIX 1: تأكيد travelID
    $travelID = isset($_POST['travelID']) ? intval($_POST['travelID']) : 0;
    if ($travelID <= 0) {
    ...
    // ✅ FIX 2: نخزن اسم الصورة فقط (مو المسار)
    $photoFileName = null;

    if (!empty($_FILES['photo']['name']) && $_FILES['photo']['error'] == 0) {

        // ✅ FIX 3: التحقق من نوع الملف
        ...
        // اسم الملف فقط
        $photoFileName = $travelID . '_' . basename($_FILES['photo']['name']);
