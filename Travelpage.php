...
$connection = mysqli_connect("sql303.infinityfree.com", "if0_37754888", " vpkmywb4", "if0_37754888_travle1");
            ...
            fetch('fetch_travels.php')
                ...
                .then(data => {
                    ...
                    data.forEach(row => {
                        ...
                        const photo = row.photo ? `<img src="${row.photo}" alt="${placeName}">` : 'No Image';
